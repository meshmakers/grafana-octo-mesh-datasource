...
# The redirect URI uses a wildcard-style path because the datasource UID is generated by Grafana.
# For local dev, we use a broad callback pattern. In production, register the exact UID.
$callbackUri = "http://localhost:3000/api/datasources/proxy/uid/grafana-octo-mesh-datasource/auth/callback"
